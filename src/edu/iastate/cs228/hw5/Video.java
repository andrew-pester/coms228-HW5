...
public class Video implements Comparable<Video> {
	...
	/**
	 * constructs a video objext with n copies
	 * 
	 * @param film
	 * @param n
	...
	/**
	 * constructs a video object with 1 copy
	 * 
	 * @param film
	 */
	...
	/**
	 * adds n number of copies to the vieo object
	 * 
	 * @param n
	...
	/**
	 * 
	 * @return the number of copies that have been rented
	 */
